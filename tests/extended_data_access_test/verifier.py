...
class Verifier:
    ...
    def start(self, host, port, other_port, result_queue):
    ...
    def nonce_requested(self, connection):
        ...
        self.result_queue.put((f"Nonce emission {connection}", duration))
    ...
    def attestation_requested(self, request_json, connection):
        ...
        duration = time.time() - start_time
        self.result_queue.put((f"Attestation emission {connection}", duration))
